  ...
  <div class="container px-6 py-4 mx-auto flex justify-between md:items-center">
    ...
    <div class="items-center flex gap-4">
      ...
      <div class="flex justify-center md:block">
        <a class="relative text-gray-700 transition-colors duration-200 transform dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300" href="/dashboard">
