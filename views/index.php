...
<?php if (isset($params)) { ?>
    <div class="mt-8 container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <?php foreach ($params as $key) {
            $fb_link = "http://www.facebook.com/sharer.php?u=http://localhost:8000/post?id={$key["postsID"]}";

            $twitter_link = "https://twitter.com/share?url=http://localhost:8000/post?id={$key["postsID"]}&amp;text=new-blog-post&amp;hashtags=blog-post";
