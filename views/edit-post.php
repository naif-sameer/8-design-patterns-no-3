...
<div class="container mx-auto py-8">
  <div class="py-4">
    <h2 class="text-4xl">Edit Post </h2>
  </div>

  <form method="POST" action="/post/edit" class="space-y-4" enctype="multipart/form-data">
    <!-- post id -->
    ...
    <div>
      ...
      <input required value="<?php echo $title; ?>" type="text" name="title" id="title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
    </div>

    <!-- content -->
    <div>
      <label for="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Post content</label>
      <textarea required name="content" id="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="content..."><?php echo $content; ?></textarea>
    </div>
    ...
    <!-- <div>
      ...
      <input value="<?php echo $image; ?>" name="image" class="block w-full text-sm rounded-lg border  cursor-pointer dark:text-gray-400 focus:outline-none focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_input_avatar_help" id="user_input_avatar" type="file">
    </div> -->
    ...
    <button type="submit" name="add_post" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit post</button>
  </form>
